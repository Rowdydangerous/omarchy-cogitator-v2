...
check "menu overlay vendored" bash -c 'grep -q "redirectApps" "$1/overlays/rowdy.menu/Menu.qml" && grep -q "roundontime\|rounding_power\|chamfer\|Chamfer\|cogitator-v2" "$1/overlays/rowdy.menu/Menu.qml"' _ "$ROOT"
